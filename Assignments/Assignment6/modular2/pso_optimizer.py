...
class BatchedGPUParticleSwarm:
    ...
    def optimize(self, batched_objective_fn, callback=None):
        ...
        for it in range(self.maxiter):
            ...
            # Returns: score, aeps, penalty, cable_dist
            scores, aeps, penalties, cable_dists = batched_objective_fn(pos)
            ...
            if callback is not None:
                ...
                callback(
                    glob_cpu, self.best_global_score, self.best_global_aep, 
                    self.best_global_penalty, self.best_global_cable_dist, it,
                    cur_cpu, float(scores[cur_best_idx]), float(aeps[cur_best_idx]), 
            ...
            if self.disp:
                ...
                print(f"For {self.n_turbines} turbines {name_str:<21} "
                      ...
                      f"AEP: {self.best_global_aep:.3f} GWh | "
