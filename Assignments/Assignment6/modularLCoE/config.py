...
# FINANCIAL PARAMETERS (for fast PI calculation)

TURB_COST_PER_MW = 1.3e6          # $/MW installed
SPOT_PRICE_AVG = 50.0             # $/MWh  (simplified average spot price)
O_AND_M_PER_MWH = 12.0            # $/MWh
RENT_PER_MW = 15000               # $/MW-yr
DISCOUNT_RATE = 0.036             # 3.6 %
PROJECT_LIFETIME = 20             # years
BOP_FIXED_PER_TURBINE = 0.5e6     # $500k fixed BoP per turbine
BOP_PER_KM_CABLE = 50e3           # $50k per km of cable


# PI OPTIMIZATION WEIGHT
# PI ranges ~0–2.  Weight chosen so that PI≈1.5 gives a term comparable
# to the old AEP term (AEP≈150 GWh × old AEP_WEIGHT=1e4 → 1.5e6).
PI_WEIGHT = 1.0e6
