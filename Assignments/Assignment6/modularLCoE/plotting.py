...
def save_history_plot(iters, pens, values, cable_dists, filename, title="", value_label="PI"):
    ...
    ax2 = ax1.twinx()
    ax2.set_ylabel(value_label, color='tab:blue')
    ax2.plot(iters, values, color='tab:blue', marker='x', label=value_label)
