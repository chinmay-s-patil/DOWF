...
from floris_cupy.core.turbine.operation_models import POWER_SETPOINT_DISABLED
...
class YawOptimization(LoggingManager):
    """
    YawOptimization is a subclass of :py:class:`floris_cupy.optimization.scipy.
    ...
    def __init__(
        ...
        Args:
            ...
            yaw_angles_baseline (iterable, optional): The baseline yaw
                ...
                to the current yaw angles in floris_cupy. Note that this variable
